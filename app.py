...
def get_available_currencies():
    try:
        ...
        return crypto_options, None
    except Exception as e:
        return None, f"Error fetching cryptocurrencies: {str(e)}"
...
def get_data(cryptos, currency):
    ...
    try:
        ...
        return None, f"Error fetching data for {pair}: {str(e)}"
...
def prepare_data(data, time_step=60):
    try:
        ...
        return None, None, None, f"Error preparing data: {str(e)}"
...
def predict_future(model, data, scaler, time_step=60, steps=180):
    try:
        ...
        return None, f"Error predicting future prices: {str(e)}"
